...
def main():
    ...
    # train
    if (mode == 'train'):
        # train_data_path = '/./chen/dataset/cifar10/cifar-10-batches-bin/train/'
        # test_data_path  = '/./chen/dataset/cifar10/cifar-10-batches-bin/test/'
